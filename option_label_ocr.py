    ...
    try:
        ...
        try:
            ...
            try:
                ...
                _ocr_available_cache = (
                    False,
                    f"Tesseract binary not available or failed: {str(e)}",
                )
...
def _process_single_mask(
    page, mask_data: Dict[str, Any], overwrite: bool, dpi: int = 300
    ...
    try:
        ...
        for page_idx, mask_data, page_key in masks_to_process:
            try:
                ...
                mask_id, detected_label, was_processed = _process_single_mask(
                    page, mask_data, overwrite, dpi
                )
